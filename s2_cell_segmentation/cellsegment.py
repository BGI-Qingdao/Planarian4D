...
def cp_main(image, name='ssDNA', cpi=None, skip=False, psize=None, saved_object='Cell'):
...
class Options:
    sargs = 'hi:n:o:p:t:m:'
    largs = ['help', 'image=', 'name=', 'outdir=', 'prefix=', 'skip', 
...
def main():
    ...
    celloutlines_file = str(opts.outdir / '{}_CellOutlines.txt'.format(opts.prefix))
