...
class SampleInfo:
    ...
    def LoadBody(self, y_lim, basic_step):
        ...
        bd.to_csv(f'./basic_cache/{self.name}.body_cell_count.csv')
        #############################
        # save data
        self.Body = bd
...
class GeneInfo:
    ...
    def LoadExp(self,ylim,basic_step):
        ...
        exp_data.to_csv(f'./basic_cache/{self.name}_{self.gene}.basic.csv')
        #############################
        # save data
...
all_gene_data.to_csv('raw_all.ml100.csv')
